...
class OrderApplication {
  ...
  factory OrderApplication.fromJson(Map<String, dynamic> json) {
    return OrderApplication(
      ...
      orderId: idFromJson(json['order_id']),
      ...
      freelancerRating: json['freelancer_rating'] != null
          ? (json['freelancer_rating'] is String
              ? double.tryParse(json['freelancer_rating'])
      ...
      freelancerReviewsCount: json['freelancer_reviews_count'] is int
          ...
          : (json['freelancer_reviews_count'] != null
              ? int.tryParse(json['freelancer_reviews_count'].toString())
              : null),
      ...
      proposedBudget: json['proposed_budget'] != null
          ? (json['proposed_budget'] is String
              ? double.tryParse(json['proposed_budget'])
              : (json['proposed_budget'] as num).toDouble())
          : null,
      proposedDeadline:
          json['proposed_deadline'] != null ? DateTime.parse(json['proposed_deadline']) : null,
